...
const getSummarizedDescription = description =>
  description &&
  `${description.substring(
    0,
    Math.min(descriptionMaxLength, description.length)
    ...
    >
      ...
      <CardContent>
        ...
        <Typography
          ...
          className={classes.detailItem}
        >
          <CalendarIcon fontSize="small" className={classes.detailIcon} />
          <DueIn date={dueDate} />
        </Typography>
